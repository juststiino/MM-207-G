...
#### Sharing: 
    - Make the recipes public or private
    - Share recipes with others by using links
#### Offline features:
    - Your own recipes can be viewed offline
    - Changes can be made offline, and will be uploaded when you are online
#### PWA:
